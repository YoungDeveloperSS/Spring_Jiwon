package young.board.util.exception;

import lombok.AccessLevel;
import lombok.Getter;
import lombok.RequiredArgsConstructor;

import static young.board.util.exception.ErrorStatusCode.*;
...
public enum ErrorCode {
    ...
    VALIDATION_MONEY_EXCEPTION(BAD_REQUEST, "허용되지 않은 금액 범위를 입력하였습니다. (0 이상)"),
    VALIDATION_DIAMETER_EXCEPTION(BAD_REQUEST, "허용되지 않은 직경 범위를 입력하였습니다. (0.0 ~ 20.0)"),
    ...
    private final young.board.util.exception.ErrorStatusCode statusCode;
